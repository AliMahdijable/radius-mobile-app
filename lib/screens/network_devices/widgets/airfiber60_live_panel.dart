...
class _AirFiber60LivePanelState extends State<AirFiber60LivePanel> {
      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          Container(
            ...
            child: Text('60 GHz',
                style: AppType.daysWordBold(color: AppColors.brandAccent)),
          ),
        ]),
  ...
  Widget _qualityBar({
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        const Spacer(),
        Text(badge, style: AppType.microBold(color: color)),
        const SizedBox(width: 6),
        Text('${percent.round()}%',
            textDirection: TextDirection.ltr,
    ...
    return _cardWrapper(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text('هامش الإشارة والسعة', style: AppType.bodyBold()),
        ]),
        const SizedBox(height: 12),
        // Signal margin
        IntrinsicHeight(
        ...
        if (utilization != null) ...[
          Row(children: [
            ...
            Text('${utilization.round()}%',
                textDirection: TextDirection.ltr,
                style: AppType.bodyBold(color: utilColor)),
          ]),
          const SizedBox(height: 4),
          ClipRRect(
            borderRadius: BorderRadius.circular(R.pill),
    ...
    return _cardWrapper(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text('أداء اللنك', style: AppType.bodyBold()),
        ]),
        const SizedBox(height: 12),
    ...
    return _cardWrapper(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (s.host.temperature != 0)
            Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('${s.host.temperature}°C',
                  textDirection: TextDirection.ltr,
                  style:
                      AppType.pillBold(color: _tempColor(s.host.temperature))),
            ]),
        ]),
        const SizedBox(height: 12),
        // CPU
        ...
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text('Uptime', style: AppType.pillBold(color: AppColors.textMid)),
          const Spacer(),
          Text(_formatUptime(s.host.uptime),
              textDirection: TextDirection.ltr, style: AppType.bodyBold()),
        ]),
      ]),
    );
  }
  ...
  Widget _percentRow({
    ...
    return Row(children: [
      ...
      SizedBox(
        width: 32,
        child: Text(label, style: AppType.pillBold(color: AppColors.textMid)),
      ),
      Expanded(
        child: ClipRRect(
          borderRadius: BorderRadius.circular(R.pill),
    ...
    return _cardWrapper(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text('Ethernet', style: AppType.bodyBold()),
          const Spacer(),
          if (s.lanSpeed != null)
            Container(
  ...
  Widget _ethRow(UbntInterface iface) {
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 6),
        Text(iface.ifname, style: AppType.pillBold(color: AppColors.textHi)),
    ...
    return _cardWrapper(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text('الموقع', style: AppType.bodyBold()),
        ]),
        const SizedBox(height: 8),
        Row(children: [
          Expanded(
